public class Program
{
    static async Task Main()
    {
        ...
        {
            eventStore.Save(evt);
            Console.WriteLine($"Saved event: {evt.GetType().Name}");
        }

        // Query
        Console.WriteLine("\nRunning Query: GetBalance");
...
Executing Commands...
Saving Events...
Saved event: DepositEvent
Saved event: WithdrawEvent
Saved event: DepositEvent

Running Query: GetBalance

Final Account Balance: 1250
 */

/*
* .1Command and Query Interfaces:
...
* 2.Bank Account and Events:
    ...
    GetBalanceQueryHandler calculates the balance by replaying events in EventStore.

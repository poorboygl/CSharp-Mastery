public class Program
{
    static void Main()
    {
        ...
        // Gửi vài thông báo mẫu
        notifier.SendNotification("System started");
        notifier.SendNotification("New user logged in");
        notifier.SendNotification("Backup completed");

        // Hủy đăng ký nếu muốn
